...
/*   Updated: 2024/07/29 18:33:22 by tnayir           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	char *nbr, t_parsing_rules rules, int group_index, int need_comma)
{
	...
	// zeros_amount = 0 : five hundred and two -> five hundred and two
	// zeros_amount = 3 : five hundred and two -> five hundred and two thousand
	if (group == NULL)
		return (0);
